...
if __name__ == "__main__":
    ...
    def get_state():
        ...
        return jsonify({"game_state": game_state.value}), 200
    ...
    def drop_token():
        ...
        if column is None or player_id is None:
            return jsonify({"error": "Missing 'column' or 'player_id'"}), 400
        response = game.drop_token(player = GameToken(player_id), column = column)
        return jsonify({"drop_state": response.value}), 200
